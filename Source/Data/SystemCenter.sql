...
--GO
--CREATE ROLE [SystemCenterRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'SystemCenterAdmin', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'SystemCenterAdmin'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'SystemCenterAdmin'
--GO
