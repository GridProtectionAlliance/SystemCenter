...
namespace WixFolderGen
{
    class Solution
    {
        ...
        public Solution(string projectName, string rootFolderName, string applicationFolder, string fileNamePostfix)
        {
            ...
            WebFeaturesDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\SystemCenterSetup\\WebFeatures"+fileNamePostfix +".wxi";
            WebFoldersDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\SystemCenterSetup\\WebFolders" + fileNamePostfix + ".wxi";
            WebFilesDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\SystemCenterSetup\\WebFiles" + fileNamePostfix + ".wxi";
        }
