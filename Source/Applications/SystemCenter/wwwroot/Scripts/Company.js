            ...
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "row" },
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "col" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("select", { className: "form-control", style: { paddingTop: 5, height: 'calc(100% - 35px)' }, value: selectedSites.map(function (ss) { return ss.ID.toString(); }), multiple: true, onChange: function (e) {
                        ...
                        } }, allSites.filter(function (allsite) { return allsite.MeterName.toLowerCase().indexOf(searchText.toLowerCase()) >= 0; }).map(function (allsite) { return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("option", { key: allsite.ID, value: allsite.ID, hidden: sites.find(function (s) { return s.OpenXDAMeterID == allsite.ID; }) != null, disabled: sites.find(function (s) { return s.OpenXDAMeterID == allsite.ID; }) != null }, allsite.MeterName); }))))),
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "card-footer" },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "btn-group mr-2" },
