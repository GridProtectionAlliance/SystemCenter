                    ...
                    <>
                        <div className="btn-group mr-2">
                            ...
                            <ToolTip
                                ...
                                Target={"SaveValues"}
                            >
                                {invalidChanges.map((change, index) => <p key={index}> <ReactIcons.CrossMark /> {change.Message}</p>)}
                        ...
                        <div className="btn-group mr-2">
                            ...
                            <ToolTip
                                ...
                                Position={'top'}
                                Target={"Clear"}>
                                {validChanges.map((change, index) => <p key={index}> <ReactIcons.Warning /> {change.Message}</p>)}
                            </ToolTip>
                        </div>
                    </> : null                 
                }
