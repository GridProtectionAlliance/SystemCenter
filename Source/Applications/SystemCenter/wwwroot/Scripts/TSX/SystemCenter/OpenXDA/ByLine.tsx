...
export default class ByLine extends React.Component<{lineID: number }, { searchText: string, dfr: boolean, pqMeter: boolean, data: Array<{ ID: number, AssetKey: string, Name: string, Location: string, Type: 'DFR' | 'PQMeter', Make: string, Model: string }>, sortField: string, ascending: boolean }, {}>{
    ...
    getMeters(): JQuery.jqXHR {
        ...
        this.jqueryHandle = $.ajax({
            type: "GET",
            url: `${homePath}api/OpenXDA/Meter/Line/${this.props.lineID}`,
