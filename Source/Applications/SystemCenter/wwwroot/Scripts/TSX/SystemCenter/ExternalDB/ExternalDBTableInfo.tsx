...
export default function ExternalDBInfo(props: { Record: SystemCenter.Types.ExternalDataBaseTable }) {
    const [record, setRecord] = React.useState<SystemCenter.Types.ExternalDataBaseTable>(props.Record);
