...
const NodeHealth = (props: IProps) => {
    ...
    const [openMICStatus, setOpenMICStatus] = React.useState<INamedStatusItem>({ Name: 'openMIC', Status: 'Loading', Details: [], ServerError: false });
    ...
    const GetOpenMICHealth = () => {
        ...
        h.done((d: INamedStatusItem) => {
            ...
            setOpenMICStatus({ Status: 'Error', Name: 'openMIC', Details: [{ Status: "Error", Description: "Errors occurred in retrieving openMIC health." }], ServerError: true })
            setStatus('error')
        })
