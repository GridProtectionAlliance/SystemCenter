...
import { PQDigestWidgetSlice } from '../Store/Store';
...
export default function WidgetForm(props: IProps) {
    ...
    const allWidgets = useAppSelector(PQDigestWidgetSlice.Data);
    const allWidgetStatus = useAppSelector(PQDigestWidgetSlice.Status);
    ...
    React.useEffect(() => {
        if (allWidgetStatus == 'uninitiated' || allWidgetStatus == 'changed')
            dispatch(PQDigestWidgetSlice.Fetch());
    }, [allWidgetStatus]);
