...
const DeviceHealthReport: Application.Types.iByComponent = (props) => {
    ...
    return (
        <div style={{ width: '100%', height: '100%' }}>
            <SearchBar<SCGlobal.DeviceHealthReport> StorageID={"SystemCenter.DeviceHealthReport.Search"} CollumnList={filterableList} SetFilter={(flds) => setSearch(flds)} Direction={'left'} defaultCollumn={standardSearch} Width={'50%'} Label={'Search'}
