    ...
    return (
        <>
            ...
            <div style={{ width: '100%', height: '100%' }}>
                <SearchBar<OpenXDA.Types.DataReader> StorageID={"SystemCenter.DataReader.Search"} CollumnList={searchFields} SetFilter={(flds) => dispatch(DataReaderSlice.DBSearch({ filter: flds, sortField, ascending }))}
