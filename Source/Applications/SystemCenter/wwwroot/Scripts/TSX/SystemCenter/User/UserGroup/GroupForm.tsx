                ...
                <div className="row">
                    <div className="col">
                        ...
                        <div className="row" style={{ position: 'absolute', top: 0, left: 100 }} hidden={props.Group.Type == 'Database'}>
                            ...
                            <span id="accountValid" hidden={valid != 'valid'}><ReactIcons.CheckMark Color="var(--success)" Size={15} /> &nbsp;<em className="small">Resolved group name.</em></span>
                            <span id="accountInvalid" hidden={valid != 'invalid'}><ReactIcons.CrossMark Color="var(--danger)" Size={15} /> &nbsp;<em className="small">Cannot resolve group name.</em></span>
                            <span id="accountUnknown" hidden={valid != 'unknown'}><ReactIcons.CrossMark Color="var(--danger)" Size={15} /> &nbsp;<em className="small">Valid group name is not in Active Directory access is limited.</em></span>
                        </div>
                        <div className="row">
                            <div className="col">
