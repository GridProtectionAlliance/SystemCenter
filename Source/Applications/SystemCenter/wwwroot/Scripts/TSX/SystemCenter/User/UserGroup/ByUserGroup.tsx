...
const ByUser: Application.Types.iByComponent = (props) => {
    ...
    return (
        <div style={{ width: '100%', height: '100%' }}>
            ...
            <SearchBar<ISecurityGroup> StorageID={"SystemCenter.Group.Search"} CollumnList={defaultSearchcols} SetFilter={(flds) => dispatch(SecurityGroupSlice.DBSearch({ filter: flds }))}
