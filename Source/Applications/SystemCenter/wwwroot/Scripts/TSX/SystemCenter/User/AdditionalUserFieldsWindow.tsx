...
function AdditionalField(props: IProps) {
	...
	const additionalUserFieldController = React.useMemo(() => new GenericController<Application.Types.iAdditionalUserField>(`${homePath}api/SystemCenter/AdditionalUserField`, "FieldName"),[])
