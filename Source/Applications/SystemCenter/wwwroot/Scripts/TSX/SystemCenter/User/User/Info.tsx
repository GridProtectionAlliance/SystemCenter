...
const UserInfo = (props: IProps) => {
    ...
    }, [props.AccountId, props.RefreshTrigger])

    function updateUser() {
        new GenericController<IUserAccount>(`${homePath}api/SystemCenter/UserAccount`, "DisplayName", true).DBAction( 'PATCH', user).then(() => props.SetRefreshTrigger(val => !val))
    }
