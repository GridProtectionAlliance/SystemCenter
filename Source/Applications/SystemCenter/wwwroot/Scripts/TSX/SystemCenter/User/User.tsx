...
import { SCSecurityRoleSlice, UserAccountSlice, UserAdditionalFieldSlice, ValueListGroupSlice, ValueListSlice } from '../Store/Store';
...
export default function UserPage(props: { UserID: string })
{
    ...
    return <User
        ...
        SecurityRoleSlice={SCSecurityRoleSlice}
