     ...
     return (
        <div style={{ width: '100%', height: '100%' }}>
            <LoadingScreen Show={pageStatus === 'loading'} />
             <SearchBar<IUserAccount> StorageID={"SystemCenter.User.Search"} CollumnList={filterableList} SetFilter={(flds) => dispatch(UserAccountSlice.DBSearch({ sortField, ascending, filter: flds }))}
