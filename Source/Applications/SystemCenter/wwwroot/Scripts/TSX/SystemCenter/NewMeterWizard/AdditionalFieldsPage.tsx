...
export default function AdditionalFieldsPage(props: IProps) {
    ...
    React.useEffect(() => {
        setCurrentAsset(props.Assets.length === 0 || props.Assets.length <= assetIndex ? null : props.Assets[assetIndex]);
    }, [assetIndex]);
        ...
        <>
            <div className="row" style={{ margin: -20, height: '100%' }}>
                ...
                <div className="col" style={{ padding: 0, height: '100%' }}>
                    {currentAsset != null ? <AdditionalFieldsWindow ID={currentAsset.ID} Type='Asset' Name={currentAsset.AssetKey} Tab={currentAsset.ID.toString()} DefaultEdit={true} HideExternal={true} HideAddAdditionalFieldButton={true} HideEditButton={true} HideResetButton={true} /> :
