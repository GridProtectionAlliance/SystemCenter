                ...
                <div className="row" style={{margin: -20}}>
                    ...
                    <div className="col" style={{padding: 20}}>
                        <div style={{ width: '100%', height: 38 }}>
                            <button className="btn btn-primary pull-right" data-toggle='modal' data-target='#assetModal' onClick={() => this.setState({NewEdit: NewEdit.New})}>Add</button>
                        </div>

                        <div style={{ width: '100%', maxHeight: window.innerHeight - 338, padding: 30, overflowY: 'auto' }}>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-primary" data-dismiss="modal" onClick={(evt) => {
                                    ...
                                    this.props.UpdateState({ Assets: list });
                                    this.setState({ NewEditAsset: this.getNewAsset('Line') })
                                }} disabled={this.disableModalSave()} hidden={this.state.NewEdit != NewEdit.New}>Save</button>
