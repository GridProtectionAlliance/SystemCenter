...
function OpenXDAIssuesPage(props: { Meter: OpenXDA.Types.Meter }) {
    ...
    React.useEffect(() => {
        const handle = OpenXDADailyStatisticController.PagedSearch([], sortField, ascending, currentPage, props.Meter.AssetKey).done(result => {
        ...
        <div className="card-body" style={{ paddingTop: 10, paddingBottom: 0, overflow: 'hidden' }}>
            <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
                <ConfigurableTable<SC.OpenXDADailyStatistic>
                    LocalStorageKey="OpenXDAIssuesConfigTable"
