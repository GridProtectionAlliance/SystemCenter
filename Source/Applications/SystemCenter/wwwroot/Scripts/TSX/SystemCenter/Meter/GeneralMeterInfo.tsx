...
export default class GeneralMeterInfoWindow extends React.Component<{ meter: OpenXDA.Meter, stateSetter: (meter: OpenXDA.Meter) => void }, { changed: boolean, TimeZones: Array<ValueListItem> }, {}> {
            ...
            <div className="card" style={{ marginBottom: 10 }}>
                ...
                <div className="card-footer">
                    <div className="btn-group mr-2">
                        <button className="btn btn-primary" type="submit" onClick={() => this.updateMeter()} disabled={!this.state.changed}>Save Changes</button>
                    </div>
                    <div className="btn-group mr-2">
                        <button className="btn btn-default" onClick={() => this.getMeter()} disabled={!this.state.changed}>Clear Changes</button>
                    </div>
                </div>
