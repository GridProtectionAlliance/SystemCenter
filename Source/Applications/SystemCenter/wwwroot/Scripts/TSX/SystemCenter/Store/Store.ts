...
export const ExternalDBTablesSlice = new GenericSlice<SystemCenter.Types.extDBTables>("ExternalDataBaseTable", `${homePath}api/OpenXDA/ExternalDBTables`, "TableName", false);
export const AdditionalFieldsSlice = new GenericSlice<SystemCenter.Types.AdditionalField>("AdditionalFields", `${homePath}api/SystemCenter/AdditionalField`, "FieldName", false);
