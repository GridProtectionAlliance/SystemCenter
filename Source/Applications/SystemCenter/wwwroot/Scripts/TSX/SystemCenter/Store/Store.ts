...
export const ExternalDatabasesSlice = new GenericSlice<SystemCenter.Types.ExternalDatabases>("ExternalDatabases", `${homePath}api/OpenXDA/ExternalDB`, "Name", false);
