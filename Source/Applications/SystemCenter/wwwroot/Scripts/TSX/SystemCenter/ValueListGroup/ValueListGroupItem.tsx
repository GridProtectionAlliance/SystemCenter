...
const controller = new GenericController<SystemCenter.Types.ValueListItem>(`${homePath}api/ValueList`, 'SortOrder');
...
export default function ValueListGroupItems(props: IProps) {
    ...
    React.useEffect(() => {
        ...
        const h = controller.PagedSearch(filters, sortKey, asc, page)
        h.done((d) => {
    ...
    }, [controller, sortKey, asc, page, props.Record, refreshTrigger]);
