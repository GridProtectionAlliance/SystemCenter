...
const ValueListGroupController = new GenericController<SystemCenter.Types.ValueListGroup>(`${homePath}api/ValueListGroup`, 'Name');
...
export default function ValueListGroup(props: IProps) {
    ...
    React.useEffect(() => {
        ...
        const handle = $.ajax({
            type: "GET",
            url: `${homePath}api/ValueListGroup/One/${props.GroupID}`,
