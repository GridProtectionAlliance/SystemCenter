...
export default function ValueListForm(props: IProps) {
    ...
    return (
        <>
            ...
            <Input<SystemCenter.Types.ValueListItem> Record={props.Record} Label={'Sort Order'} Field={'SortOrder'} Type='number' Feedback={'Sort Order must be an integer.'} Valid={Valid} Setter={props.Setter} />
        </>
    );
}