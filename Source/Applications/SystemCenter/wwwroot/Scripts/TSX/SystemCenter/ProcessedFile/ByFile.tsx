...
const ByFile: Application.Types.iByComponent = (props) => {
    ...
    return (
        <div style={{ width: '100%', height: '100%' }}>
            ...
            <SearchBar<OpenXDA.Types.DataFile> StorageID={"SystemCenter.DataFile.Search"} CollumnList={filterableList} SetFilter={(flds) => setSearch(flds)} Direction={'left'} defaultCollumn={DefaultSearchField.DataFile as Search.IField<OpenXDA.Types.DataFile>} Width={'100%'} Label={'Search'}
