...
const MATLABAnalyticInfoWindow = (props: { Record: OpenXDA.Types.MATLABAnalytic }) => {
    ...
    return (
        <div className="card" style={{ marginBottom: 10 }}>
            ...
            <div className="card-footer">
                ...
                <ToolTip Show={hover == 'update' && (errors.length > 0 || record == props.Record)} Position={'top'} Target={"Update-Info"}>
...
export default MATLABAnalyticInfoWindow;