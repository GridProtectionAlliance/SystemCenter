...
export default function CustomerForm(props: IProps) {
    ...
    return (<div className="row" style={{marginLeft: 0}}>
        <div className="col">
            <Input<SystemCenter.Customer> Record={props.Customer} Field={'CustomerKey'} Feedback={'AccountName of less than 25 characters is required.'} Valid={valid} Setter={(record) => props.stateSetter(record)} />
