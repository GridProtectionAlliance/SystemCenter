...
export default class CFGParser {
    ...
    constructor(contents: string, meterKey: string) {
        ...
        this.Analogs = data.slice(2, analogCounts + 2).map((a: Array<string>, index) => (
            {
                ID: index,
                Meter: meterKey,
                Asset: '',
        ...
        this.Digitals = data.slice(2 + analogCounts, 2 + analogCounts + digitalCounts).map((a: Array<string>, index) => (
            {
                ID: analogCounts + index,
                Meter: meterKey,
                Asset: '',
                ...
                Enabled: true,
                Series: [{
                    ID: 0, ChannelID: 0, SeriesType: 'Values',
                    SourceIndexes: a[1]
