...
const UserSelect = (props: IProps) => {
    ...
    React.useEffect(() => {
        ...
        const h = new GenericController<Application.Types.iUserAccount>(`${homePath}api/OpenXDA/UserAccount`, "Name", true).PagedSearch(filters, sortField, ascending, page);
    ...
    }, [sortField, ascending, page, filters])
