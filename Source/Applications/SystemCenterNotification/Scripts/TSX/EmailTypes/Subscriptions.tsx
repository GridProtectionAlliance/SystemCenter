...
const Subscriptions = (props: IProps) => {
    ...
    const eventSubscriptionController = React.useMemo(() => new GenericController<SubscribeEmails>(`${homePath}api/EventSubscription`, 'Email'),[])
    ...
    React.useEffect(() => {
        ...
        const h = eventSubscriptionController.PagedSearch(filters, sortField, ascending, page);
    ...
    }, [props.Record.ID, sortField, ascending, page, refreshTrigger, eventSubscriptionController.PagedSearch])
