                    ...
                    <div className="card-footer">
                        <div className="btn-group mr-2">
                            <button className={"btn btn-primary" + (email.Template != null && email.Template.length > 0 && hasChanged ? '' : ' disabled')}
                                type="submit"
                                onClick={() => { if (email.Template != null && email.Template.length > 0 && hasChanged) new GenericController<EmailType>(`${homePath}api/OpenXDA/EmailType`, "Name", true).DBAction('PATCH', email); }}
                                data-tooltip='submit'
