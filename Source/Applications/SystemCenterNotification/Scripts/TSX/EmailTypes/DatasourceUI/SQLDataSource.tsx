                    ...
                    <div className="col">
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                value={props.Settings.find(s => s.Name == 'ConnectionString') == null ? '' : props.Settings.find(s => s.Name == 'ConnectionString').Value}
                            />
                        </div>
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                value={props.Settings.find(s => s.Name == 'DataProviderString') == null ? '' : props.Settings.find(s => s.Name == 'DataProviderString').Value}
                            />
                        ...
                        <div className="form-group">
                            ...
                            <textarea
                                rows={4}
                                className={props.Settings.find(s => s.Name == 'SQLStatement') != null && props.Settings.find(s => s.Name == 'SQLStatement').Value.length > 1  ? 'form-control' : 'form-control is-invalid'}
                                onChange={(evt) => {
                                    if (evt.target.value !== '')
                                        props.SetSetting({
                                            ID: 0, Name: 'SQLStatement',
                                ...
                                value={props.Settings.find(s => s.Name == 'SQLStatement') == null ? '' : props.Settings.find(s => s.Name == 'SQLStatement').Value}
                            />
                            <div className="invalid-feedback">
