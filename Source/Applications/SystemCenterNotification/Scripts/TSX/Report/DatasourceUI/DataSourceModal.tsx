...
const scheduledDataSourceSettingController = new GenericController<IScheduledEmailDataSourceSetting>(`${homePath}api/OpenXDA/ScheduledEmailDataSourceSetting`, "Name", false);
...
const DataSourceModal = (props: IProps) => {
    ...
    React.useEffect(() => {
        const h = new GenericController<IScheduledDataSource>(`${homePath}api/OpenXDA/ScheduledEmailDataSource`, "Name", false).Fetch();
