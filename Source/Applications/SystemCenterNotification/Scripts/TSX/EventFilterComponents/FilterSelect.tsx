...
const meterController = new GenericController<SystemCenter.Types.DetailedMeter>(`${homePath}api/OpenXDA/Event/Meter`, "Name", true);
const assetController = new GenericController<OpenXDA.Types.DetailedAsset>(`${homePath}api/OpenXDA/Event/Asset`, "AssetName", true);
const groupController = new GenericController<OpenXDA.Types.AssetGroup>(`${homePath}api/openXDA/Event/AssetGroup`, 'Name');
const substationController = new GenericController<SystemCenter.Types.DetailedLocation>(`${homePath}api/OpenXDA/Event/Location`, "LocationKey", true);
