...
public class UserStatisticsTest {
  ...
  public void userStatisticsApplicationNavigation() {
        ...
        IWebElement pqFileViewerLink = wait.Until(ExpectedConditions.ElementToBeClickable(By.LinkText("PQFileViewer")));
        pqFileViewerLink.Click();

        // Navigate to PQDashboard
        IWebElement pqDashboardLink = wait.Until(ExpectedConditions.ElementToBeClickable(By.LinkText("PQDashboard")));
        pqDashboardLink.Click();

        // Navigate to PQ Browser
        IWebElement pqBrowserLink = wait.Until(ExpectedConditions.ElementToBeClickable(By.LinkText("PQ Browser")));
        pqBrowserLink.Click();

        // Navigate to OpenXDA
        IWebElement openXdaLink = wait.Until(ExpectedConditions.ElementToBeClickable(By.LinkText("OpenXDA")));
        openXdaLink.Click();

        // Navigate to OpenSee
        IWebElement openSeeLink = wait.Until(ExpectedConditions.ElementToBeClickable(By.LinkText("OpenSee")));
        openSeeLink.Click();

        // Navigate to Notification Pages
        IWebElement notificationPagesLink = wait.Until(ExpectedConditions.ElementToBeClickable(By.LinkText("Notification Pages")));
        notificationPagesLink.Click();

        // Navigate to MiMD
        IWebElement miMdLink = wait.Until(ExpectedConditions.ElementToBeClickable(By.LinkText("MiMD")));
        miMdLink.Click();
    }
  [Test]
